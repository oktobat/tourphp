	...
	<div id="container">
		...
		<div class="location_area member">
			<div class="row">
				...
				<p class="location">MEMBER <span class="path">/</span> 정보수정</p>
			</div>
		</div>	
		<!-- //location_area -->
		...
		<div class="bodytext_area row">
			<!-- appForm -->
			<form action="member_modify.php?num=<?=$num?>" method="post" name="appForm" class="appForm">
				<fieldset>
				...
				<p class="btn_line">
					<button type="button" class="btn" onclick="chk_input()">수정</button>
